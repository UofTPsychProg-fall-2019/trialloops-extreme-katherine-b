...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/katherinebak/Desktop/Grad School Classes/PSY1210-Programming/trialloops-extreme-katherine-b/PS6_lastrun.py',
...
Instruct = visual.TextStim(win=win, name='Instruct',
    text='You will see images of animals on the screen. Press the left arrow key if the image is a bear. Press the right arrow key if the image is a hippo. Make your response as quickly as possible. \n\n\nPRESS ANY KEY TO CONTINUE',
    font='Arial',
...
picturefile = ['correct.jpeg' , 'incorrect.jpeg']
feedback_2 = visual.ImageStim(
    win=win,
    name='feedback_2', 
    image='sin', mask=None,
    ori=0, pos=(0, 0), size=(0.5, 0.5),
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('picturestim.csv'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if image.status == STARTED:
            ...
            if tThisFlipGlobal > image.tStartRefresh + 0.6-frameTolerance:
    ...
    if key_resp.corr:
        ...
        picture = picturefile[1]
    feedback_2.setImage(picture)
    # keep track of which components have finished
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if feedback_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > feedback_2.tStartRefresh + 1.5-frameTolerance:
                # keep track of stop time/frame for later
